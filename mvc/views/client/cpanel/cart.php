...
<header id="header"><!--header-->
	...
	<section id="cart_items">
		<div class="container">
			<div class="breadcrumbs">
				<ol class="breadcrumb">
				  <li class="active" style="color: #1ea89c; font-weight: bold; font-size: 20px;">Giỏ Hàng Của Bạn </li>
				</ol>
			</div>
    ...
    <form method="POST">
		<section id="do_action">
			<div class="container">
				<div class="heading">
					<h3 style="color: #1ea89c;">Thanh Toán Đơn Hàng</h3>
				</div>
				<div class="row">
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						<div class="total_area">
							<ul>
								...
								<button style="margin-left: 225px;" name="submit" class="btn btn-default update">Thanh Toán</button>
						</div>
					</div>
				</div>
			</div>
