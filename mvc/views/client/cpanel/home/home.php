					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1>BABYBOO</h1>
									<h2>Chắp cánh cho con</h2>
									<!-- <button type="button" class="btn btn-default get">Get it now</button> -->
								 </div> 
								<div class="col-sm-6">
									<img style="min-height: 328px; object-fit: cover;max-height: 328px;min-width: 480px;" src="public/images/img_banner/sls01.png" class="girl img-responsive" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img style="min-height: 328px; object-fit: cover;max-height: 328x;min-width: 480px;" src="public/images/img_banner/<?=$values['slider_img']?>" class="girl img-responsive" alt="" />
								</div>
							</div>
							<?php }?>
						</div>
        ...
        <div class="row">
            <div class="col-sm-3" id="mobi">
					<div class="left-sidebar">
                        ...
                        <!-- Sản phẩm hot -->
                        <div class="sphot">
                            <a href="javascript:void(0)" class="btn-default add-to-cart" idproduct="139">
                                <img src="public/images/img_banner/banerl.jpeg" alt="">
                        ...
                        <div class="col-sm-12">
                            <div class="product-image-wrapper"style="max-height: 450px; min-width:250px; max-width: 262px;">
                                <div class="single-products"style="max-height: 450px;min-width:250px; max-width: 262px;">
                                    <div class="productinfo text-center" style="max-height: 450px; min-width:250px;">
                                        <a href="javascript:void(0)" class="btn-default add-to-cart" idproduct = "<?=$values['id']?>">
                                             <img style="max-height: 250px;min-height: 250px;object-fit: cover; max-width: 264px;" src="public/images/img_product/<?=$values["img_product"]?>" alt="" />
                                        </a>   
                                ...
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper" style="max-height: 500px; min-height: 400px;">
                                        <div class="single-products">
                                            ...
                                            <a href="javascript:void(0)" class="btn-default add-to-cart" idproduct = "<?=$values['id']?>">
                                                <img style="max-height: 250px;object-fit: cover;" src="public/images/img_product/<?=$values["img_product"]?>" alt="" />
                                            </a>    
                                                <h4 style="text-decoration: line-through;"><?=number_format ($values["price"] , $decimals = 0 , $dec_point = "," , $thousands_sep = "." )?>đ</h4>
                                                <h2 style="margin:unset"><?=number_format ($values["price"] * (1-$values["sale_product"]/100) , $decimals = 0 , $dec_point = "," , $thousands_sep = "." ) ?> đ</h2>
                                                <p><?=$values["name"]?></p>
