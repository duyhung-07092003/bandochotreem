                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a style="height: 35px" class="btn btn-danger submit" href="javascript:void(0)" onclick="del(<?=$values['id']?>, '<?=htmlspecialchars($values['name'], ENT_QUOTES) ?>', '<?=base.'admin/deleteproduct/'?>', 'sản phẩm')">Xóa</a>
                                </td>
                            </tr>
                            <?php }?>
                        </tbody>
