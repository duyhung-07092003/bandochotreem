    ...
    class ajax extends controller{
        ...
        function details(){
            ...
            echo '
                <div class="col-sm-12 padding-right">
                    <i style="font-size: 35px; color: orange; margin: 10px 10px; position: absolute;right: 0;z-index: 2;" class="fas fa-times-circle"></i>
                    <div class="product-details" style="min-height: 470px;"><!--product-details-->
                        ...
                        <div class="col-sm-6">
                            <div class="product-information"><!--/product-information-->
                                ...
                                <h2 style="color: #1ea89c;">'.$product[0]["name"].'</h2>
        ...
        function paging(){
            ...
            if(isset($_POST["id"])){
                ...
                $totalpage =ceil($numberproduct/8);
                for($i = 1; $i <= $totalpage;$i++){
                    if($current_page != $i){
                        if($current_page -7 < $i && $i < $current_page +7 ){
                            echo '
        ...
        function search(){
            if(isset($_POST["content"])){
                ...
                foreach($product as $key=>$values){ 
                    echo '
                        <div class="col-sm-4">
                        <div class="product-image-wrapper"style="max-height: 5000px;">
                            <div class="single-products"style="max-height: 500px;">
                                <div class="productinfo text-center" style="max-height: 500px;">
                                    <img style="max-height: 200px;;object-fit: cover;" src="public/images/img_product/'.$values["img_product"].'" alt="" />
        ...
        function orderdetails(){
            ...
            <section id="cart_items">
                <div class="container">
                    <h3 style="color:#1ea89c;">Chi Tiết Đơn Hàng</h3>
                    <a href="'.base.'home/history" name="submit" class="btn btn-default" style="background-color:#1ea89c; color:white;">Trở Về</a>
